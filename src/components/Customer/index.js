...
import MVPIMG from './mvp.jpg'
import MVPstyles from './index.less';
          ...
          <Col span={6}>
            <div style={styles.colItem}>
              ...
              <div
                ...
                onClick={() => { }}
              >
                <ImageViewer options={{ url: 'data-src' }} className={MVPstyles.imgViewer}>
                  <img
          ...
          <Row  >
            ...
            <Col span={6}>
              <div style={styles.colItem}>
                ...
                <span>
                  {customerInfo && customerInfo.liveProvinceDesc && customerInfo.liveCityDesc &&
